...
import ShopRadio from '@/components/shop/shop-radio';
...
const columns: ColumnDef<BuygentTableProps>[] = [
    ...
    },
    {
        ...
        cell: ({ getValue }) => {
            ...
            return <div className="lowercase p-4">{formatted}원</div>
        },
    },
    {
...
export default function Index() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="flex flex-col gap-4 rounded-xl p-8 overflow-x-auto justify-center">

                <ShopCheckbox id='check' /><Label htmlFor='check'>체크</Label>
                <ShopCheckbox id='check1' size='medium' /><Label htmlFor='check'>체크</Label>
                <RadioGroup>
                    <RadioGroupItem value='1'>test</RadioGroupItem>
                    <RadioGroupItem value='2' variant='black'>test</RadioGroupItem>
                </RadioGroup>
                <ShopToggle />
                ...
                <ShopButton variant={'secondary'} size={'sm'}>스몰</ShopButton>
                <ShopIconButton variant={'black'}> <ShopIcon name='!Blank' className='size-16' /> </ShopIconButton>
                <ShopIconButton variant={'white'}> <ShopIcon name='!Blank' className='size-16' /> </ShopIconButton>
                <ShopIconButton variant={'outline'} size={'rectangleLg'}> <ShopIcon name='!Blank' className='size-15' /> </ShopIconButton>
                <ShopIconButton variant={'outline'} size={'rectangleSm'}> <ShopIcon name='!Blank' className='size-15' /> </ShopIconButton>
                <ShopChip variant={'primary'} size={'lg'}>액션</ShopChip>
                <ShopChip variant={'secondary'} size={'lg'}>액션</ShopChip>
                <ShopChip variant={'primary'} size={'sm'}>액션</ShopChip>
                <ShopChip variant={'secondary'} size={'sm'}>액션</ShopChip>
                ...
                <Card className=' w-full md:w-auto' >
                    <CardContent className='flex flex-col items-center justify-center gap-4'>
                        ...
                        <div className='font-black text-4xl'>3,200,000</div>
                    </CardContent>
                </Card>
                <Card className=' w-full md:w-auto'>
                    <CardContent className='flex flex-col items-center justify-center gap-4'>
            ...
            <div className="flex flex-wrap gap-4 rounded-xl p-8 overflow-x-auto md:justify-center">
                <div>
                    <div className='font-black text-xl'>바이전트</div>
                    <div>
                        <PublicTable data={data} columns={columns} />
                    </div>
                </div>
                <div>
                    <div className='font-black text-xl'>바이클</div>
                    <div>
                        <PublicTable data={data} columns={columns} />
                    </div>
                </div>
