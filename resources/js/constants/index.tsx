...
export const mainNavItems: NavItem[] = [
    ...
    },
    {
        ...
        icon: ShoppingBag,
        items: [
            { title: '상품 등록', href: '/seller/products/product_1' },
            { title: '상품 조회/수정', href: '/seller/products/product_2' },
        ],
    },
    {
        role: 'seller',
        ...
        icon: Van,
        items: [
            { title: '배송 관리', href: '/seller/orders/order_1' },
            { title: '출고중지 요청', href: '/seller/orders/order_2' },
            { title: '반품 관리', href: '/seller/orders/order_3' },
            { title: '교환 관리', href: '/seller/orders/order_4' },
